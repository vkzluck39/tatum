 ...
 */
export declare const signBitcoinKMSTransaction: (tx: TransactionKMS, privateKeys: string[]) => Promise<any>;
/**
 ...
 * @returns transaction data to be broadcast to blockchain.
 */
export declare const prepareBitcoinSignedTransaction: (testnet: boolean, body: TransferBtcBasedBlockchain) => Promise<any>;
/**
