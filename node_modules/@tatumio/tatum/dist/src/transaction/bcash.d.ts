import { TransactionKMS, TransferBchBlockchain } from '../model';
/**
 ...
 */
export declare const sendBitcoinCashTransaction: (testnet: boolean, body: TransferBchBlockchain) => Promise<import("../model").TransactionHash>;
/**
