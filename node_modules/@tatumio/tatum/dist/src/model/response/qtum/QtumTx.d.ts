...
export declare class QtumIRawTransactions {
    totalItems: number;
    from: number;
    to: number;
    items: QtumTransactionObj[];
}
export declare class QtumTransactionObj {
    txid: string;
    version: number;
    locktime: number;
...
export declare class QtumIRawTransactionInfo {
    txid: string;
    version: number;
    locktime: number;
