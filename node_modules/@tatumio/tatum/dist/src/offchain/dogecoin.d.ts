 ...
 */
export declare const sendDogecoinOffchainTransaction: (testnet: boolean, body: TransferBtcBasedOffchain) => Promise<import("../model").SignatureId | {
    id: string;
    txId: string;
    completed: boolean;
} | {
 ...
 */
export declare const signDogecoinOffchainKMSTransaction: (tx: TransactionKMS, mnemonic: string, testnet: boolean) => Promise<any>;
/**
 ...
 * @returns transaction data to be broadcast to blockchain.
 */
export declare const prepareDogecoinSignedOffchainTransaction: (testnet: boolean, data: WithdrawalResponseData[], amount: string, address: string, mnemonic?: string | undefined, keyPair?: KeyPair[] | undefined, changeAddress?: string | undefined, xpub?: string | undefined, multipleAmounts?: string[] | undefined, signatureId?: string | undefined) => Promise<any>;
