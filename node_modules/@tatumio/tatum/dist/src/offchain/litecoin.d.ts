 ...
 */
export declare const sendLitecoinOffchainTransaction: (testnet: boolean, body: TransferBtcBasedOffchain) => Promise<import("../model").SignatureId | {
    id: string;
    txId: string;
    completed: boolean;
} | {
 ...
 */
export declare const signLitecoinOffchainKMSTransaction: (tx: TransactionKMS, mnemonic: string, testnet: boolean) => Promise<any>;
/**
 ...
 * @returns transaction data to be broadcast to blockchain.
 */
export declare const prepareLitecoinSignedOffchainTransaction: (testnet: boolean, data: WithdrawalResponseData[], amount: string, address: string, mnemonic?: string | undefined, keyPair?: KeyPair[] | undefined, changeAddress?: string | undefined, xpub?: string | undefined, multipleAmounts?: string[] | undefined, signatureId?: string | undefined) => Promise<any>;
